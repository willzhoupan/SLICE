...
class LLMEngine:
    ...
    def add_request(
        ...
        #print(f"--- [DEBUG SCHEDULER ADD] ID: {request.request_id} | Reward: {getattr(request, 'reward', 'N/A')} ---")
        ...
        # 必须手动赋值，因为 process_inputs 内部不会处理你的自定义参数
        request.tpot_target = tpot_target
        request.u_value = u_value
        request.reward = reward
        request.preoutput_len = preoutput_len
