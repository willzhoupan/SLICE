...
class GPUModelRunner(
    ...
    def execute_model(
        ...
        with (
            ...
            if not hasattr(self, "_debug_step_count"): self._debug_step_count = 0
            self._debug_step_count += 1
            
            if self._debug_step_count % 10 == 0: # 每 50 步打印一次
                print(f"🚀 [SLICE Batch Info] Step: {self._debug_step_count} | Requests: {num_reqs} ")
            # ----------------------
